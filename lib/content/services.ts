...
export const serviceCategories: ServiceCategoryItem[] = [
  {
    ...
    tone: "indigo",
    title: "خدمات پایه",
    bullets: ["پرونده دیجیتال سلامت", "هوش تجاری (BI)", "ثبت خودکار داده‌های آزمایشگاهی", "تجمیع سوابق"],
  },
  {
    icon: "DeviceMobile",
    tone: "teal",
    title: "خدمات فردی (اپلیکیشن)",
    bullets: ["اپلیکیشن خودمراقبتی رایگان", "ثبت داده‌های سلامت", "پیگیری شخصی روند سلامت", "تحلیل شخصی داده‌ها"],
  },
  {
    icon: "Stethoscope",
    tone: "orange",
